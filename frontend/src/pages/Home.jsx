      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="px-5 py-2.5 text-sm font-medium text-slate-700 hover:text-indigo-600 transition"
            >
              Log in
            </Link>
            <Link
              to="/register"
              className="px-6 py-2.5 text-sm font-semibold text-white bg-slate-900 rounded-full hover:bg-indigo-600 shadow-lg shadow-slate-200 transition-all active:scale-95"
            >
              Get Started
            </Link>
          </div>
      ...
      <main className="pt-32">
        ...
        <section className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/login"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-indigo-600 text-white font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 hover:shadow-2xl hover:shadow-indigo-200 transition-all"
            >
              Find a Ride <Search size={18} />
            </Link>
            <Link
              to="/login"
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white text-slate-900 font-bold border-2 border-slate-100 flex items-center justify-center gap-2 hover:border-indigo-100 hover:bg-indigo-50/30 transition-all"
            >
