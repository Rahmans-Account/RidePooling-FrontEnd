  ...
  useEffect(() => {
    const fetchName = async () => {
      try {
        ...
        // fail silently; keep placeholder name
      }
    };
    fetchName();
  }, []);
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      <main className="flex-1 p-10">
        <h1 className="text-3xl font-semibold mb-2">Welcome, {displayName}! 👋</h1>
        <p className="text-gray-500 mb-8">Your ridepooling dashboard is ready.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="bg-white shadow-sm rounded-2xl p-5">
            ...
            <p className="text-gray-500 mb-4">Share your commute and save money.</p>
            <button
          ...
          <div className="bg-white shadow-sm rounded-2xl p-5">
            ...
            <p className="text-gray-500 mb-4">Book a ride with a colleague or friend.</p>
            <button
